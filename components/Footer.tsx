...
import { EmailIcon } from './IconComponents.tsx';
    ...
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2 text-sm">
                <li><ReactRouterDOM.Link to="/collection" className="hover:text-[var(--c-accent-primary)] transition-colors opacity-80 hover:opacity-100">{t('nav_Shop')}</ReactRouterDOM.Link></li>
                 <li><ReactRouterDOM.Link to="/blog" className="hover:text-[var(--c-accent-primary)] transition-colors opacity-80 hover:opacity-100">{t('nav_Blogs')}</ReactRouterDOM.Link></li>
                 <li><ReactRouterDOM.Link to="/pricing-guide" className="hover:text-[var(--c-accent-primary)] transition-colors opacity-80 hover:opacity-100">{t('nav_The_Different_Types_of_Amber')}</ReactRouterDOM.Link></li>
                 <li><ReactRouterDOM.Link to="/amber-colors" className="hover:text-[var(--c-accent-primary)] transition-colors opacity-80 hover:opacity-100">{t('nav_The_Variety_of_Colors_&_Tones')}</ReactRouterDOM.Link></li>
                 <li><ReactRouterDOM.Link to="/glossary" className="hover:text-[var(--c-accent-primary)] transition-colors opacity-80 hover:opacity-100">{t('nav_Glossary_of_Terms')}</ReactRouterDOM.Link></li>
                <li><ReactRouterDOM.Link to="/about" className="hover:text-[var(--c-accent-primary)] transition-colors opacity-80 hover:opacity-100">{t('nav_About_Us_&_Policies')}</ReactRouterDOM.Link></li>
                <li><ReactRouterDOM.Link to="/faqs" className="hover:text-[var(--c-accent-primary)] transition-colors opacity-80 hover:opacity-100">{t('nav_FAQs')}</ReactRouterDOM.Link></li>
                <li><ReactRouterDOM.Link to="/contact" className="hover:text-[var(--c-accent-primary)] transition-colors opacity-80 hover:opacity-100">{t('nav_Contact_Us')}</ReactRouterDOM.Link></li>
              </ul>
            </div>
            <div>
      ...
      <footer className="md:hidden fixed bottom-0 left-0 right-0 bg-[var(--c-surface)] border-t border-[var(--c-border)] shadow-t-lg z-50">
          <div className="flex justify-around items-center h-16">
              <ReactRouterDOM.Link to="/collection" className="flex flex-col items-center text-[var(--c-text-secondary)] hover:text-[var(--c-accent-primary)] transition-colors">
              ...
              <ReactRouterDOM.Link to="/build-your-set" className="flex flex-col items-center text-[var(--c-text-secondary)] hover:text-[var(--c-accent-primary)] transition-colors">
              ...
              <ReactRouterDOM.Link to="/blog" className="flex flex-col items-center text-[var(--c-text-secondary)] hover:text-[var(--c-accent-primary)] transition-colors">
              ...
              <ReactRouterDOM.Link to="/contact" className="flex flex-col items-center text-[var(--c-text-secondary)] hover:text-[var(--c-accent-primary)] transition-colors">

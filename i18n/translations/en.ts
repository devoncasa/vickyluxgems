export const translations = {
    ...
    'glossary_def_burmite': 'The specific name for amber found in Myanmar, notable for being the oldest known amber at approximately 99 million years old. Highly prized for its hardness and diversity of prehistoric inclusions.',
    'glossary_term_chakra': 'Chakra',
    'glossary_def_chakra': 'An ancient Sanskrit term meaning "wheel" or "disk". In spiritual traditions, chakras are centers of energy within the human body. There are seven primary chakras, each associated with specific physical, emotional, and spiritual states. Gemstones are often used to balance or align these energy centers.',
    'glossary_term_e_e_a_t': 'E-E-A-T',
    'glossary_def_e_e_a_t': 'An acronym for Experience, Expertise, Authoritativeness, and Trustworthiness. It is a set of quality guidelines used by search engines like Google to evaluate the quality of a web page and the credibility of its content creator. High E-E-A-T is crucial for good rankings, especially for topics related to health, finance, and well-being.',
    ...
    'glossary_def_fossil_resin': 'The scientific term for amber. It is tree resin that, over millions of years, has undergone polymerization and hardening processes, turning it from a soft, sticky substance into a hard, stable gemstone.',
    'glossary_term_gia': 'GIA',
    'glossary_def_gia': 'Gemological Institute of America. One of the world’s foremost authorities on gemology, renowned for its strict grading standards and comprehensive certification reports for diamonds and colored gemstones.',
    ...
    'glossary_def_heirloom_quality': 'A term used to describe jewelry of exceptional quality and durability, made to last for generations. It implies the use of high-quality materials and superior craftsmanship, making it suitable to be passed down as a family treasure.',
    ...
    'glossary_def_mala': 'Also known as Japa beads or prayer beads, a Mala is a string of beads (traditionally 108) used in various spiritual traditions like Hinduism and Buddhism for meditation and prayer. It is used to count mantras or breaths, helping the practitioner to stay focused.',
    'glossary_term_metaphysical_properties': 'Metaphysical Properties',
    'glossary_def_metaphysical_properties': 'Refers to the spiritual, healing, or energetic attributes believed to be associated with a particular gemstone. These properties are based on historical lore, spiritual tradition, and intuitive belief rather than verifiable science. Examples include "rose quartz for love" or "amethyst for calm".',
    'glossary_term_mohs_hardness': 'Mohs Hardness',
    'glossary_def_mohs_hardness': 'A scale from 1 to 10 that characterizes the scratch resistance of various minerals. A higher number indicates a harder material. For example, Diamond is a 10, Ruby is a 9, and Burmese Amber is about 2.5-3.',
    ...
    'glossary_def_topical_authority': 'An SEO concept where a website becomes recognized by search engines as a definitive expert on a particular subject. This is achieved by creating comprehensive, high-quality, and interlinked content that covers all aspects of a topic, much like this glossary does for gems.',
    ...
    'seo_custom_rosary_desc': 'Design a meaningful, personal Catholic Rosary. Choose from materials like Rose Quartz, Lapis Lazuli, and more to create a unique devotional piece.',
    'seo_custom_rosary_keywords': 'custom rosary, build a rosary, personalized rosary, catholic prayer beads, rosary builder, devotional jewelry, spiritual gifts',
    ...
    'custom_rosary_materials_p1': 'Selecting the materials for your rosary can deepen its personal significance. We offer a curated selection of high-quality gemstones and natural materials, each with its own spiritual resonance.',
    ...
    'custom_rosary_cta_subtitle': 'Use our intuitive builder to select your materials, components, and design. Craft a rosary that will be a cherished companion on your spiritual journey for years to come.',
    'custom_rosary_cta_button': 'Build Your Custom Rosary',

    // --- Custom Tesbih Page ---
    'seo_custom_tesbih_title': 'Custom Tesbih (Tasbih) Builder | Vicky Lux Gems',
    'seo_custom_tesbih_desc': 'Design your personal Tesbih (Tasbih, Misbaha) for dhikr. Choose from sacred materials like Agarwood (Oud), Jade, Lapis Lazuli, and our rare Burmese Amber.',
    'seo_custom_tesbih_keywords': 'custom tesbih, tasbih builder, misbaha, islamic prayer beads, dhikr beads, agarwood tasbih, burmese amber tesbih, personalized islamic gifts',
    'custom_tesbih_title': 'Design Your Custom Tesbih',
    'custom_tesbih_subtitle': 'An Object of Beauty for Remembrance',
    'custom_tesbih_intro': 'The Tesbih (also known as Tasbih or Misbaha) is an intimate and essential tool for dhikr (the remembrance of Allah). Creating a custom Tesbih allows you to select materials that are not only beautiful but also hold personal and spiritual significance, enhancing your devotional practice.',
    'custom_tesbih_history_title': 'A Legacy of Devotion',
    'custom_tesbih_history_p1': 'The use of prayer beads is a tradition deeply rooted in Islamic history, serving as a companion for Muslims in their daily remembrance and praise of God. The Tesbih helps maintain focus and rhythm during supplications.',
    'custom_tesbih_history_p2': 'Traditionally composed of 33 or 99 beads, the design often includes a lead bead (Imame) and a tassel, each element crafted with care and intention.',
    ...
    'custom_tesbih_cta_subtitle': 'Use our builder to create a Tesbih that reflects your personal taste and deepens your connection to your faith. Select your materials and design to craft a timeless piece for yourself or as a meaningful gift.',
    ...
    'seo_tesbih_rosary_builder_keywords': 'prayer bead builder, custom tesbih, custom rosary, build a tasbih, personalized prayer beads, islamic gifts, catholic gifts, devotional items',
    'tesbih_rosary_builder_page_title': 'Prayer Bead Builder',
    'tesbih_rosary_builder_page_subtitle': 'Craft a unique Tesbih or Rosary that reflects your personal faith and style. Choose your tradition, materials, and specifications to build a timeless spiritual tool.',
    ...
    'seo_prayer_bead_customizer_keywords': 'prayer bead customizer, build rosary, build tasbih, custom rosary, custom tasbih, personalized prayer beads, catholic gifts, islamic gifts',
    ...
    'trb_summary_tassel_beads': 'Tassel connecting beads',
    'trb_summary_intro_beads_small': 'Intro Beads (3)',
    'trb_summary_intro_beads_large': 'Intro Bead (1)',
    'trb_summary_size_mm': '{{size}} mm',
    'trb_summary_est_weight': 'Estimated Weight',
    ...
    // --- Construction Popup ---
    'popup_construction_title': "⚠️ Our website is under development.",
    'popup_construction_body': "The design and graphic elements are still in progress. However, you can explore the site — some amber bracelets or amber sets are customizable and ready for viewing. Some pieces may be especially appealing to you.",
    'popup_construction_date_label': 'Last updated:',
    'popup_construction_btn1': "Go to Main Website →",
    'popup_construction_btn2': "Go to Facebook →",
    'popup_construction_btn3': "Continue on This Page →",

    'seo_amber_guide_desc': "Explore the ultimate guide to Burmese Amber. Learn about its 99-million-year-old history, scientific properties, authenticity tests, and its role in the modern market.",
    'seo_amber_guide_keywords': "Burmese amber guide, Burmite guide, what is Burmite, amber history, amber science, amber authenticity, amber market, amber collecting"
};
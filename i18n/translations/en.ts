...
export const translations = {
    ...
    'nav_Prayer_Beads': 'Prayer Beads',
    'nav_Precious_Stones': 'Precious Stones',
    'nav_Semi-Precious_Stones': 'Semi-Precious Stones',
    'nav_Amber_Pendants': 'Amber Pendants',
    'nav_Amber_Rings': 'Amber Rings',
    'nav_Amber_Necklaces': 'Amber Necklaces',
    'nav_Decorative_Stones': 'Decorative Stones',
    ...
    'mala_builder_clipboard_message': "Hello! I'd like to pre-order this custom Mala:\n- Amber Color: {{amberColor}}\n- Grade: {{grade}}\n- Bead Size: {{beadSize}}mm\n- Quantity: {{beadQuantity}} beads\n- Amulet: {{amulet}}\n- Metal Caps: {{metal}}\n- Estimated Total: {{totalPrice}}\n\nTo learn more about the pre-order process, please visit: {{link}}",
    'bracelet_builder_clipboard_message_new': "Hello! I'd like to pre-order this bracelet:\n- Design Code: {{designCode}}\n- Est. Wrist Size: {{wristSize}}cm\n- Beads:\n{{beadSummary}}- Est. Total: {{totalPrice}}\n\nTo learn more about the pre-order process, please visit: {{link}}",
    ...
    'seo_custom_tesbih_keywords': 'custom tesbih, build a tesbih, personalized prayer beads, islamic prayer beads, dhikr beads, agarwood tasbih, heirloom misbaha',
    ...
    'seo_prayer_bead_customizer_desc': 'Visually design your own Catholic Rosary or Islamic Tasbih. Select materials for every component and see a diagram of your creation.',
    ...
    'seo_juzu_builder_desc': 'Design and build an authentic Japanese Juzu prayer bead set. Select your materials, style, and tassels to create a unique piece for Buddhist practice.',
    'seo_juzu_builder_keywords': 'juzu builder, custom juzu, japanese prayer beads, buddhist mala, nenju, omodama, oyadama, bespoke buddhist jewelry',
    'seo_amber_guide_desc': 'Your complete resource for understanding the history, science, and significance of the world\'s oldest amber. Explore our ultimate guide to Burmite.',
    'seo_amber_guide_keywords': 'burmese amber guide, what is burmite, amber history, authenticate amber, amber science, amber value, amber market, amber collecting',
    ...
    'custom_rosary_history_p1': 'The Catholic Rosary is a cherished form of devotion, a meditative prayer that honors the lives of Jesus and the Virgin Mary. Its structure, with its decades of beads, crucifix, and centerpiece medal, guides the faithful through a cycle of reflection and prayer.',
    ...
    'custom_rosary_materials_p1': 'The materials you choose for your rosary can add deep spiritual significance. We offer a curated selection of high-quality gemstones and precious materials, each with its own energy and symbolism.',
    ...
    'custom_rosary_cta_subtitle': 'Use our intelligent builder to select your materials and begin crafting a piece that will be treasured for a lifetime.',
    'custom_rosary_cta_button': 'Build Your Rosary',

    // --- New Translations for Custom Tesbih Page ---
    'custom_landing_page_title': 'Custom Spiritual Jewelry',
    'custom_landing_page_subtitle': 'Craft a unique piece for your spiritual practice. Choose your tradition to begin designing a personal and meaningful tool for devotion.',
    'custom_landing_juzu_title': 'Japanese Juzu',
    'custom_landing_juzu_desc': 'Design a traditional Buddhist prayer mala for chanting and meditation.',
    'custom_landing_tesbih_title': 'Islamic Tesbih',
    'custom_landing_tesbih_desc': 'Create a personal Misbaha for dhikr and remembrance.',
    'custom_landing_rosary_title': 'Christian Rosary',
    'custom_landing_rosary_desc': 'Craft an heirloom rosary for prayer and contemplation.',
    'custom_landing_amber_title': 'Custom Amber Jewelry',
    'custom_landing_amber_desc': 'Build a unique amber bracelet or mala based on your design.',
    'custom_card_back_juzu_full': 'Create an authentic Japanese Juzu, choosing from a wide range of traditional materials. Customize the omodama (main beads), oyadama (parent beads), and tassel style to suit your specific Buddhist school or personal preference. Our builder guides you through creating a formal (108 beads) or informal set.',
    'custom_card_back_tesbih_full': 'Design a beautiful and functional Islamic Tesbih (Tasbih/Misbaha). Select from sacred materials like Agarwood (Oud), Burmese Amber, or fine gemstones. Customize the bead count (33 or 99), and choose the materials for your imame and tassel to create a deeply personal tool for dhikr.',
    'custom_card_back_rosary_full': 'Craft a meaningful, heirloom-quality Christian Rosary. Our configurator allows you to select from a variety of gemstones or precious Burmese Amber for the Ave and Pater beads. Choose your Crucifix and Centerpiece from our curated collection to complete your personal devotional piece.',
    'custom_card_back_mala_full': 'Use our original builder to design a custom amber bracelet or prayer mala. This tool allows you to create a repeating pattern of different amber colors and sizes, which is then extrapolated to fit your wrist size. It\'s perfect for creating a truly unique, personalized amber piece.',
    'custom_landing_cta': 'Start Building',

    // --- New Translations for Payment Page ---
    'payment_title': 'Payment Selection',
    'payment_subtitle': 'Please choose your preferred payment method.',
    'order_summary_title': 'Order Summary',
    'payment_method_card_title': 'Credit/Debit Card & PayPal',
    'payment_method_card_desc': 'This section would contain the integrated payment gateway for standard credit/debit card and PayPal transactions. For now, this is a placeholder.',
    'payment_method_card_placeholder': '[Standard Payment Gateway Form]',
    'payment_method_local_qr_title': 'Pay with Thai QR (Local Bank Transfer)',
    'payment_method_usdt_title': 'Pay with Cryptocurrency (USDT) - 10% OFF',
    'usdt_wallet_address_label': 'Wallet Address',
    'usdt_network_label': 'Network',
    'usdt_network_value': 'BNB Smart Chain (BEP-20)',
    'usdt_amount_label': 'Amount to Send',
    'usdt_conditions_title': 'Conditions of Payment',
    'usdt_condition_1': 'Please ensure you are sending <strong>USDT</strong> on the <strong>BNB Smart Chain (BEP-20)</strong> network. Transactions sent on other networks are irreversible and will result in a permanent loss of funds.',
    'usdt_condition_2': 'Your order will be processed once the transaction receives a sufficient number of confirmations on the blockchain (typically 1-5 minutes).',
    'usdt_condition_3': 'All cryptocurrency transactions are final and cannot be reversed. Please double-check the wallet address and amount before sending.',
    'payment_status_waiting': 'Waiting for payment...',
    'payment_status_confirmed': '✅ Payment Received!',
    'payment_confirm_button': 'I Have Sent The Payment',
    'original_price_label': 'Original Price:',
    'your_order_total_label': 'Your Order Total:',
    'usdt_discount_label': 'USDT Discount (10%):',
    'new_total_label': 'New Total:',

    // --- New Translations for Custom Tesbih Page ---
    'custom_tesbih_title': 'Custom Heirloom Tesbih',
    'custom_tesbih_subtitle': 'Design a personal Misbaha for dhikr and remembrance.',
    'custom_tesbih_intro': 'A Tesbih is a profound tool for spiritual focus, a companion for the practice of dhikr (remembrance of God). At Vicky LuxGems, we honor this tradition by helping you create a custom, heirloom-quality Tesbih that is as meaningful as it is beautiful.',
    'custom_tesbih_history_title': 'A Tradition of Remembrance',
    'custom_tesbih_history_p1': 'The Tesbih, also known as Tasbih or Misbaha, is a string of beads used by Muslims to count repetitions of prayers or phrases praising Allah. Traditionally composed of 33 or 99 beads, it serves as a tactile guide, helping the mind to remain focused and centered during devotional practice.',
    'custom_tesbih_history_p2': 'By designing your own Tesbih, you imbue this sacred practice with personal significance, choosing materials that resonate with your intentions and aesthetic.',
    'custom_tesbih_materials_title': 'Materials of Meaning',
    'custom_tesbih_materials_p1': 'The materials you select can add layers of significance to your practice. We offer a curated selection of precious and sacred materials, each with its own history and energy.',
    'custom_tesbih_materials_p2': 'From the sacred scent of Agarwood (Oud), the ancient energy of Burmese Amber, or the cool tranquility of Jade, we can help you select the perfect combination to create a Tesbih that is both a powerful spiritual tool and a work of art.',
    'custom_tesbih_cta_title': 'Ready to Create Your Tesbih?',
    'custom_tesbih_cta_subtitle': 'Use our intelligent builder to select your materials and begin crafting a piece that will be a cherished companion on your spiritual path.',
    'custom_tesbih_cta_button': 'Build Your Tesbih',

    // --- New Translations for Tesbih/Rosary Builder Page ---
    'tesbih_rosary_builder_page_title': 'Custom Prayer Bead Builder',
    'tesbih_rosary_builder_page_subtitle': 'Craft an authentic Tesbih or Rosary tailored to your spiritual practice using our intelligent design system.',
    ...
    'trb_summary_grade': 'Grade',
    'trb_summary_material': 'Main Material',
    'trb_summary_amber_type': 'Amber Type',
    'trb_summary_components': 'Component Sizing (Est.)',
    'trb_summary_main_beads': 'Main Beads (x{{count}})',
    'trb_summary_disks': 'Disks',
    'trb_summary_imame': 'Imame',
    ...
    'trb_summary_intro_beads_small': 'Intro Beads (Small x3)',
    'trb_summary_intro_beads_large': 'Intro Beads (Large x1)',
    ...
    'pbc_page_subtitle': 'Visually design your own Catholic Rosary or Islamic Tasbih. Select materials for every component and see a diagram of your creation.',
    'pbc_choose_rosary': 'Catholic Rosary',
    'pbc_choose_tasbih': 'Islamic Tasbih',
    'pbc_change_type': 'Change Prayer Bead Type',
    'pbc_your_build': 'Your Build',
    ...
    'pbc_component_Centerpiece___Medal': 'Centerpiece / Medal',
    'pbc_component_Chain___Cord': 'Chain / Cord',
    'pbc_component_Main_Beads_99_': 'Main Beads (99)',
    'pbc_component_Disks___Separators': 'Disks / Separators',
    'pbc_component_Imame___Head_Bead': 'Imame / Head Bead',
    'pbc_component_Tepelik___Tassel_Head': 'Tepelik / Tassel Head',
    'pbc_component_Tassel_Cord': 'Tassel Cord',
    
    // --- New Translations for Juzu Builder ---
    'juzu_step1_title': 'Step 1: Define Juzu Structure',
    'juzu_gender_style': 'Gender Style',
    'juzu_type': 'Juzu Type',
    'juzu_tassel_shape': 'Tassel Shape',
    'juzu_tassel_material': 'Tassel Material',
    'juzu_material_Agarwood_Oud_': 'Agarwood (Oud)',
    'juzu_material_Burmese_Amber': 'Burmese Amber',
    'juzu_burmese_amber_color': 'Burmese Amber Color',

    // --- Infographic Section ---
    'infographic_title_teaser': 'Click here for infographic about Burmese Amber',
    'infographic_prompt_teaser': 'Click or Scroll Down to Explore',
    'infographic_close_button_label': 'Close infographic',
    'infographic_main_title': 'The Treasures of Myanmar',
    'infographic_main_subtitle': 'A journey into the ancient origins and geological wonders of Burmese Amber and the world\'s most coveted gemstones.',
    'infographic_amber_title': 'Burmese Amber',
    'infographic_amber_subtitle': 'A 100-Million-Year-Old Time Capsule',
    'infographic_stat_amber_age_label': 'Million Years Old',
    'infographic_stat_amber_age_desc': 'Formed in the Cretaceous period, offering a direct link to the age of dinosaurs.',
    'infographic_stat_amber_species_label': 'Extinct Species',
    'infographic_stat_amber_species_desc': 'The most diverse range of prehistoric life found in any amber on Earth.',
    'infographic_stat_amber_hardness_label': 'Mohs Hardness',
    'infographic_stat_amber_hardness_desc': 'Significantly harder and more durable than most other types of amber.',
    'infographic_stat_amber_market_label': 'China\'s Amber Market %',
    'infographic_stat_amber_market_desc': 'Represents a significant portion of the high-end amber market in Asia.',
    'infographic_amber_inclusions_title': 'Inclusions: A Prehistoric Zoo',
    'infographic_amber_inclusion_item1': 'Insects & Arachnids',
    'infographic_amber_inclusion_item2': 'Dinosaur Feathers',
    'infographic_amber_inclusion_item3': 'Snakes & Lizards',
    'infographic_amber_inclusion_item4': 'Marine Life',
    'infographic_amber_inclusion_item5': 'Ancient Flowers',
    'infographic_timeline_title': 'The Journey of Burmite',
    'infographic_timeline_1_title': '~99 Million Years Ago (Cretaceous)',
    'infographic_timeline_1_desc': 'Coniferous trees in a tropical coastal forest in what is now Myanmar produce vast amounts of resin. This resin traps local flora and fauna, from insects to dinosaur feathers.',
    'infographic_timeline_2_title': '1st Century AD',
    'infographic_timeline_2_desc': 'First documented historical records show that Burmite is known and commercially exploited for trade and jewelry.',
    'infographic_timeline_3_title': 'Mid-19th Century',
    'infographic_timeline_3_desc': 'Burmese Amber becomes known to Western science, sparking interest in its unique paleontological value.',
    'infographic_timeline_4_title': 'Present Day',
    'infographic_timeline_4_desc': 'Recognized as a treasure for both gemology and science, Burmite is highly prized by collectors, jewelers, and researchers worldwide for its beauty and the secrets it holds.',
    'infographic_gemstones_title': 'Myanmar\'s Gemstone Legacy',
    'infographic_gemstones_subtitle': 'The Cradle of Jewels',
    'infographic_stat_gem_rubies_label': '% Of World\'s Rubies',
    'infographic_stat_gem_rubies_desc': 'Historically, the legendary Mogok Valley has been the premier source of the finest rubies.',
    'infographic_stat_gem_jadeite_label': '% Of Quality Jadeite',
    'infographic_stat_gem_jadeite_desc': 'Myanmar is the world\'s powerhouse for high-quality jadeite, including Imperial Jade.',
    'infographic_stat_gem_ruby_price_label': 'Million USD for a Ruby',
    'infographic_stat_gem_ruby_price_desc': '"The Sunrise Ruby," a 25.59-carat Burmese gem, set a world record.',
    'infographic_gem_card_amber_title': 'Burmese Amber',
    'infographic_gem_card_amber_hardness': 'Hardness:',
    'infographic_gem_card_amber_trait': 'Defining Trait:',
    'infographic_gem_card_amber_trait_value': 'A 99-million-year-old time capsule.',
    'infographic_gem_card_amber_back_title': 'Burmite: A Prehistoric Time Capsule',
    'infographic_gem_card_amber_back_desc': 'The world\'s oldest amber, Burmite is a 99-million-year-old time capsule offering a direct portal to the age of dinosaurs.',
    'infographic_gem_card_amber_back_source': 'Source:',
    'infographic_gem_card_amber_back_source_value': 'Hukawng Valley, Myanmar',
    'infographic_gem_card_amber_back_identifier': 'Identifier:',
    'infographic_gem_card_amber_back_identifier_value': 'Superior hardness & Cretaceous-era inclusions.',
    'infographic_gem_card_amber_back_belief': 'Belief:',
    'infographic_gem_card_amber_back_belief_value': 'Holds ancient Earth wisdom for grounding and protection.',
    'infographic_gem_card_amber_back_fact': 'Did You Know?:',
    'infographic_gem_card_amber_back_fact_value': 'It\'s the only amber known to contain non-avian dinosaur feathers.',
    'infographic_stories_title': 'Stories in Stone: Legendary Gems',
    'infographic_stories_sunrise_ruby_title': 'The Sunrise Ruby',
    'infographic_stories_sunrise_ruby_p1': 'The Sunrise Ruby is a 25.59-carat Burmese ruby from Mogok, famed for its vivid "pigeon\'s blood" color. Sold for over $30 million USD, it holds the record as the most expensive ruby ever auctioned, outpricing even many diamonds per carat.',
    'infographic_stories_sunrise_ruby_p2': 'Its unmatched purity, size, and saturation—certified as unheated—established Burmese rubies as the world’s most valuable colored gemstones. Named after a poem by Rumi, this gem is more than rare—it’s a modern legend in high jewelry.',
    'infographic_stories_imperial_jade_title': 'Imperial Jade',
    'infographic_stories_imperial_jade_p1': 'Imperial Jade from Hpakant, Myanmar, is the finest grade of jadeite, prized for its glowing emerald-green hue and smooth, oily luster. Once reserved for Chinese emperors, it symbolizes protection, harmony, and spiritual connection.',
    'infographic_stories_imperial_jade_p2': 'Revered for millennia in East Asian cultures, Imperial Jade is not just a gem—it’s a sacred stone believed to bridge the physical and spiritual worlds while attracting luck and longevity to its wearer.',
    'infographic_comparison_title': 'Myanmar vs. The World: A Gemstone Showdown',
    'infographic_table_feature': 'Feature',
    'infographic_table_burmese_ruby': 'Burmese (Myanmar) Ruby',
    'infographic_table_african_ruby': 'African (Mozambique) Ruby',
    'infographic_table_color': 'Color',
    'infographic_table_color_burmese': '"Pigeon\'s Blood" - a pure, vivid red with strong red fluorescence.',
    'infographic_table_color_african': 'Can be beautiful, but often has a slight orange or purplish secondary tone.',
    'infographic_table_clarity': 'Clarity',
    'infographic_table_clarity_burmese': 'Often contains fine, silk-like rutile inclusions that give it a soft, velvety glow.',
    'infographic_table_clarity_african': 'Typically has higher clarity with fewer large inclusions than Burmese rubies.',
    'infographic_table_fluorescence': 'Fluorescence',
    'infographic_table_fluorescence_burmese': 'Strong to intense red fluorescence under UV light, making it glow even in daylight.',
    'infographic_table_fluorescence_african': 'Lower to medium fluorescence due to higher iron content.',
    'infographic_table_rarity': 'Rarity & Value',
    'infographic_table_rarity_burmese': 'Extremely rare, especially in larger sizes. The global benchmark for value.',
    'infographic_table_rarity_african': 'More readily available, making it a more accessible but generally less valuable alternative.',
    'infographic_map_title': 'Geographic Origin',
    'infographic_map_subtitle': 'The Land of Jewels',
    'infographic_map_desc': 'Myanmar\'s unique geological history, born from the collision of tectonic plates, created the perfect conditions for these rare treasures to form. The mountainous regions in the north are particularly rich.',
    'infographic_map_loc1_title': 'Hukawng Valley:',
    'infographic_map_loc1_desc': 'The world\'s primary source of Cretaceous-era Burmese Amber.',
    'infographic_map_loc2_title': 'Mogok Stone Tract:',
    'infographic_map_loc2_desc': 'A legendary valley so rich in gems it\'s often called "The Valley of Rubies." It also produces world-class Sapphires and Spinels.',
    'infographic_map_loc3_title': 'Hpakant:',
    'infographic_map_loc3_desc': 'The epicenter of high-quality Jadeite mining, producing the coveted Imperial Jade.',
    'infographic_organic_vs_mineral_title': 'Organic vs. Mineral: A Tale of Two Treasures',
    'infographic_organic_vs_mineral_amber_title': 'Burmese Amber',
    'infographic_organic_vs_mineral_amber_origin': 'Origin:',
    'infographic_organic_vs_mineral_amber_origin_value': 'Organic (Fossilized Tree Resin)',
    'infographic_organic_vs_mineral_amber_age': 'Age:',
    'infographic_organic_vs_mineral_amber_age_value': '~99 Million Years',
    'infographic_organic_vs_mineral_amber_hardness': 'Hardness:',
    'infographic_organic_vs_mineral_amber_hardness_value': 'Soft (2.5 - 3 Mohs)',
    'infographic_organic_vs_mineral_amber_feature': 'Key Feature:',
    'infographic_organic_vs_mineral_amber_feature_value': 'Contains prehistoric life (inclusions)',
    'infographic_organic_vs_mineral_gems_title': 'Myanmar Gemstones',
    'infographic_organic_vs_mineral_gems_origin_value': 'Inorganic (Crystalline Minerals)',
    'infographic_organic_vs_mineral_gems_age_value': 'Formed deep in Earth\'s history',
    'infographic_organic_vs_mineral_gems_hardness_value': 'Very Hard (8 - 9 Mohs)',
    'infographic_organic_vs_mineral_gems_feature_value': 'Valued for color, clarity, and brilliance'
};

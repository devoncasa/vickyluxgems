    ...
    if (!details) {
        return (
            <div className="text-center py-20">
                ...
                <ReactRouterDOM.Link to="/build-your-set" className="mt-6 inline-block btn-primary text-white font-bold py-2 px-6 rounded-lg">
                ...
                <div className="max-w-2xl mx-auto mt-10">
                    ...
                    <div className="mt-8 text-center">
                        ...
                        <p className="mt-3 text-sm text-[var(--c-text-secondary)]">{t('order_confirmation_instructions')}</p>
                         <ReactRouterDOM.Link to="/collection" className="mt-8 inline-block text-[var(--c-accent-primary)] hover:text-[var(--c-heading)] font-semibold transition-colors group">
